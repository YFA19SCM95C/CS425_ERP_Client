...
import { getInventoryList } from '../../api/table';
...
export const Inventory = () => {
  ...
  const { tableData, setTableData, deleteUserById, updateUsername, refreshUserList, loading, setLoading, currentPage, setCurrentPage, inventoryList, refreshInventoryList } = store.tableStore;
  ...
  return useObserver(() => {
    ...
    return (
      <div style={{padding: 24}}>
        ...
        */}
        <PermissionChecker permission={'8'}>
          <AddInventory />
        </PermissionChecker>
        <Table
          rowKey='inventoryID'
